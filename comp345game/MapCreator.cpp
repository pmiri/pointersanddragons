	...
	while (running)
	{
		...
		if (userInput == "(l)" || userInput == "l" || userInput == "L" || userInput == "(L)")
		{
			...
			else if (userInput == "(c)" || userInput == "c" || userInput == "C" || userInput == "(C)")
			{
				...
				{
					std::cout << "Map number " << i << " has a height of " << loadedCampaign.getMapAt(i).getLength() << " tiles and a width of " << loadedCampaign.getMapAt(i).getWidth() << "tiles.\n";
				}
		...
		else if (userInput == "(n)" || userInput == "n" || userInput == "N" || userInput == "(N)")
		{
			...
			else if (userInput == "(c)" || userInput == "c" || userInput == "C" || userInput == "(C)")
			{
				...
				{
					std::cout << "Map number " << i << " has a height of " << customCampaign.getMapAt(i).getLength() << " tiles and a width of " << customCampaign.getMapAt(i).getWidth() << "tiles.\n";
				}
	...
	while (running)
	{
		...
		if (userInput == "(c)" || userInput == "(C)" || userInput == "c" || userInput == "C")
		{
			...
			else if (userInput == "(r)" || userInput == "(R)" || userInput == "r" || userInput == "R")
			{
				...
				{
					std::cout << "Map number " << i << " has a height of " << campaignToEdit.getMapAt(i).getLength() << " tiles and a width of " << campaignToEdit.getMapAt(i).getWidth() << "tiles.\n";
				}
				int index = MapCreator::getMapIndex(campaignToEdit.getSize());
